...
weight = pd.read_csv('../data/mean_a_closest_100_1_virtual-T-RA16.csv')
bias = pd.read_csv('../data/mean_b_closest_100_1_virtual-T-RA16.csv')
...
num_nodes_per_layer.append(original_model.layers[-1].weight.size(0))
...
for i in range(1, 8):
    input_file = pd.read_excel('../data/T-real_samples.xlsx')
